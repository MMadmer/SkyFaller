...
{
	UUsefulFunctions::DestroyAttachedActorsByClass(this, AActor::StaticClass());
	ClearAllHism();
}
...
{
	UUsefulFunctions::DestroyComponentsByClass(this, UHierarchicalInstancedStaticMeshComponent::StaticClass());
}
