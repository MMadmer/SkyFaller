...
public:
	...
	UTextureRenderTarget2D* SetupCapture(float EdgeTestDepth, const int32 RTRes = 256);
...
private:
	...
	static FVector SnapPixelWorldSize(const float PX, const float PY, const float PWS);
