...
public:
	...
	/** Enable/disable water ripples.
	 *  (this just enables or disables custom depth on all child components -
	 *  no need to use the component if you want to set those values yourself elsewhere)*/
	...
	*/
	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(EditCondition = "bEnableInteractiveStateSwitching"),
		Category = "UIWS")
...
public:
	...
	/** Called to update list of static and skeletal mesh comps.
	 *  Call it whenever you add another component if you need want this component to control it's interactivity state*/
