...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Easy Multi Save | Actors",
		meta = (DisplayName = "Load Game Actors", BlueprintInternalUseOnly = "true", WorldContext = "WorldContext"))
	static UEMSAsyncLoadGame* AsyncLoadActors(UObject* WorldContext,
	                                          UPARAM(meta = (Bitmask, BitmaskEnum = ELoadTypeFlags)) int32 Data,
	                                          bool bFullReload);
