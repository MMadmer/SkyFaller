...
/** Blueprint Library function accessors */
	...
	void DeleteCustomSave(const UEMSCustomSaveGame* SaveGame);
...
protected:
	...
	void SerializeStructProperties(const UObject* Object);
	void SerializeScriptStruct(const UStruct* ScriptStruct);
	void SerializeArrayStruct(const FArrayProperty* ArrayProp);
	void SerializeMap(const FMapProperty* MapProp);
